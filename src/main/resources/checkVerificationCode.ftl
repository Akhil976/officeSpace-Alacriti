...
<div id="body">
	...
	<div  class="form" style="margin-top:100px;">
			  <ul id="loginPage" class="tab-group" style="margin-left:170px !important;">
			    <li class="tab" ><a href="/OfficeSpace/html/forgotPassword.html">Move</a></li>
			  </ul>
	<style>
		p{
			color:gray;
	...
	<h1>Check your mail for Verification code.</h1>
	<p>Suggestion: Move to step-2</p>
	<div id="header">
...
<script type="text/javascript" src="/OfficeSpace/files/login/js/forgotPassword.js"></script>
	<script>
		$(document.body).on("click","#loginPage",function(){
			window.location.href = "/OfficeSpace/html/forgotPassword.html";
		});
	</script>
</html>
